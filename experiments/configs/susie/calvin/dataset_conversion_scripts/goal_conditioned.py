...
Seems to be splitting each "episode" into segments of len 1000
Seems like each raw episode_XXX.npz file is only a single trajectory?
THe loop stacks the single timesteps into full episodes 
